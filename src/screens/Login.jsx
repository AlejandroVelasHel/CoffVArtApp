...
export const Login = ({navigation}) => {
    ...
    const styles = {
        inputEmail: {
            ...
            borderWidth: 1,
            borderRadius: 10,
            borderColor: errorsLogin.email !== '' ? "#ff4757" : "#12121250",
        ...
        inputPassword: {
            ...
            borderWidth: 1,
            borderRadius: 10,
            borderColor: errorsLogin.password !== '' ? "#ff4757" : "#12121250",
            backgroundColor: '#ffffff90',
        },
        inputActive: {
            paddingHorizontal: 10,
        ...
        labelEmail: {
            ...
            color: errorsLogin.email !== '' ? "#ff4757" : "#12121250",
            fontWeight: "bold",
            fontSize: 12
        },
        labelPassword: {
            ...
            left: 10,
            backgroundColor: "transparent",
            color: errorsLogin.password !== '' ? "#ff4757" : "#12121250",
            fontWeight: "bold",
            fontSize: 12
        },
        inputActiveLabel: {
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        />
                        <Text
                            style={email.trim() !== '' ? styles.inputFilledLabelEmail : isEmailActive ? styles.inputActiveLabel : styles.labelEmail}
                            onPress={() => emailRef.current.focus()}>Correo Electrónico</Text>
                        {
                    ...
                    <View style={{
                        ...
                        />
                        <Text
                            style={password.trim() !== '' ? styles.inputFilledLabelPassword : isPasswordActive ? styles.inputActiveLabel : styles.labelPassword
